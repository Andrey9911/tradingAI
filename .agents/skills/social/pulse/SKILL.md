<!-- Source: https://github.com/alirezarezvani/claude-skills/tree/main/research/pulse/skills/pulse/SKILL.md -->
<!-- Trading AI guardrail: use this skill only for research context. Do not implement or execute auto-posting. -->
---
name: pulse
