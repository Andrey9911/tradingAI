<!-- Source: https://github.com/alirezarezvani/claude-skills/tree/main/marketing-skill/skills/copywriting/SKILL.md -->
<!-- Trading AI guardrail: use this skill only for copy drafts. Do not implement or execute auto-posting. -->
---
name: "copywriting"
